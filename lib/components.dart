...
Widget buildTasksItems({
  ...
  onDismissed: (direction) // هنا هقوله لما اسحب يمين او شمال اي اللي المفروض يحصل
  {
  ...
  child: Padding(
    ...
    child:  Row(
      children: [
        ...
        IconButton( // to update status to done
          onPressed: ()
          {
        ...
        IconButton( // to update status to archive
          onPressed: ()
          {
            ToDoAppCubit.get(context).updateInToDatabase(
              status: 'archive',
...
Widget tasksBuilder({
  ...
  return ConditionalBuilder(
    ...
    builder: (context)=>ListView.separated(
      itemBuilder: (context, index)=> buildTasksItems(record: tasks[index],context: context,),
